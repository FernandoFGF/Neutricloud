...
################################################################################
## Form generated from reading UI file 'calendarr.ui'
##
...
class Ui_calendarr(object):
    def setupUi(self, calendarr):
        if not calendarr.objectName():
            calendarr.setObjectName(u"calendarr")
        calendarr.resize(800, 600)
        calendarr.setMaximumSize(QSize(800, 600))
        calendarr.setStyleSheet(u"QWidget {\n"
...
"\n"
"")
        self.centralwidget = QWidget(calendarr)
        ...
        self.calendarWidget.setGeometry(QRect(11, 155, 781, 441))
        calendarr.setCentralWidget(self.centralwidget)

        self.retranslateUi(calendarr)

        QMetaObject.connectSlotsByName(calendarr)
    # setupUi

    def retranslateUi(self, calendarr):
        calendarr.setWindowTitle(QCoreApplication.translate("calendarr", u"Neutricloud", None))
