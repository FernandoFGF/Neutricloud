...
class Ui_inventory(object):
    def setupUi(self, inventory):
        ...
        inventory.setMaximumSize(QSize(800, 600))
        inventory.setStyleSheet(u"QWidget {\n"
...
"")
        ...
        self.explorer = QTreeView(self.centralwidget)
        self.explorer.setObjectName(u"explorer")
        self.explorer.setGeometry(QRect(5, 151, 791, 421))
        self.label_data = QLabel(self.centralwidget)
        self.label_data.setObjectName(u"label_data")
        self.label_data.setGeometry(QRect(4, 576, 791, 20))
    ...
    def retranslateUi(self, inventory):
        inventory.setWindowTitle(QCoreApplication.translate("inventory", u"Neutricloud", None))
